...
<br>
It’s a simple and responsive one-page website designed to introduce the extension, highlight its key features, and redirect users to the official [Chrome Web Store]() page for installation.
...
```bash
git clone https://github.com/fchavonet/web-gpt_stats_landing_page.git
```
...
You can also test the web application online by clicking [here](https://fchavonet.github.io/web-gpt_stats_landing_page/). 
...
<table>
    ...
    <tr valign="top">
        <td align="center">
            <picture>
                <source media="(prefers-color-scheme: dark)" srcset="./assets/images/screenshot-desktop_landing_page-dark.webp">
                <source media="(prefers-color-scheme: light)" srcset="./assets/images/screenshot-desktop_landing_page-light.webp">
                <img src="./assets/images/screenshot-desktop_landing_page-light.webp" alt="Screenshots">
            </picture>
        </td>
        <td align="center">
            <picture>
                <source media="(prefers-color-scheme: dark)" srcset="./assets/images/screenshot-mobile_landing_page-dark.webp">
                <source media="(prefers-color-scheme: light)" srcset="./assets/images/screenshot-mobile_landing_page-light.webp">
                <img src="./assets/images/screenshot-mobile_landing_page-light.webp" alt="Mobile Screenshot" width="100%">
            </picture>
        </td>
    </tr>
</table>
...
- Include dynamic previews from the extension (animated screenshots or GIFs).
